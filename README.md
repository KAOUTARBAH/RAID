...
- **OS** : Linux Ubuntu 22.04 LTS  
- **Disque 1** : pour le système  
- **3 disques supplémentaires** de 5 Go chacun pour le RAID (la taille doit être identique pour tous les disques).
...
```bash
touch /home/wilder/Data-RAID5/test_raid5.txt
mkdir /home/wilder/Data-RAID5/dossier_test
```

- Vérifiez leur présence :

```bash
ls -l /home/wilder/Data-RAID5
```
